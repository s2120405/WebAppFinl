...
function create_new_event(){
    ...
    $type= $_POST['ptype'];
    $result = $events->new_event($place,$event_name, $event_start,$event_end,$event_date, $type);
    if($result){
...
function update_event(){
    ...
    $event_date=$_POST['Event_date'];
    $type= $_POST['ptype'];
    $result = $events->update_event($place, $event_name, $event_start,$event_end,$event_date, $rental_id, $type);
    if($result){
        header('location: ../index.php?page=event');
    }
}
